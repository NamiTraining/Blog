...
//                $deleteUrl = route('dashboard.users.delete', $row->id);
//                return '
//                <a href="' . $editUrl . '" class="edit btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
//                <a id="deleteBtn" data-id="' . $row->id . '" class="delete btn btn-danger btn-sm" data-toggle="modal" data-target="#deletemodal"><i class="fa fa-trash"></i></a>';
//            })
//            ->addColumn('status', function ($row) {
//                return $row->status == null ? __('words.not activated') : __('words.' . $row->status);
//            })
